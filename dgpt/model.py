...
Kept deliberately small (PRD 7.1): vocab ~65, 4 layers, 4 heads, n_embd 128.
Runs on CPU or MPS. The same module is used by the baseline, workers, and the
coordinator (for the optional held-out loss check).
"""
